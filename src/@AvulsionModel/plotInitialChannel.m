function plotInitialChannel(obj)
%plotChannelElevations plots the channel elevations vs. the channel cells

IC = obj.initialChannelElevations;

cellLengths = obj.initialChannelCellLengths;
lenXX = length(IC);
  ...
  ax.XAxis.TickLabelFormat = '%,.0f';
    ...
    legend('Initial Riverbed');
    %hold on; scatter(xx,IC,'.b'); %TODO
    grid on;
    
  %% title
  title('Initial channel elevations');
